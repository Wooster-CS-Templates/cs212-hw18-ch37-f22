...
```sh
prompt> python3 disk.py -a 10,11 -G
```
...
```sh
prompt> python3 disk.py -a 10,18 -G
```
...
```sh
prompt> python3 disk.py -a 10,18 -c
...
Sector:  10  Seek:  0  Rotate:105  Transfer: 30  Total: 135
